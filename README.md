...
Минимальный порог активных пользователей в течении 12 часов может говорить о том, что **сервер недоступен для подключения**, что периодически случается, при этом будет доступен icmp и порт.
